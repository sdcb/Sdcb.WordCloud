...
public class FillCacheTest
{
    ...
    public unsafe void BitmapNotBgra8888_ThrowsArgumentException()
    {
        ...
        // act & assert
        var ex = Assert.Throws<ArgumentException>(() => WordCloud.FillCache(bmp, HorizontalOrVertical.Horizontal, cache, rect));
    ...
    public unsafe void CacheCornersTest()
    {
        ...
        // act
        WordCloud.FillCache(bmp, HorizontalOrVertical.Horizontal, cache, topLeft);
        WordCloud.FillCache(bmp, HorizontalOrVertical.Horizontal, cache, topRight);
        WordCloud.FillCache(bmp, HorizontalOrVertical.Vertical, cache, bottomLeft);
        WordCloud.FillCache(bmp, HorizontalOrVertical.Vertical, cache, bottomRight);
    ...
    public unsafe void CheckCovers()
    {
        ...
        // act
        WordCloud.FillCache(bmp, HorizontalOrVertical.Horizontal, cache, r1);
        WordCloud.FillCache(bmp, HorizontalOrVertical.Vertical, cache, r2);
